...
-- Create trigger for automatic enrollment creation
DROP TRIGGER IF EXISTS create_enrollment_on_verification ON ethiopian_payments;
CREATE TRIGGER create_enrollment_on_verification
