...
// Initialize Stripe only if the secret key is present.
// This prevents the build from crashing when the env variable is missing (e.g. on Vercel PR builds).
...
if (process.env.STRIPE_SECRET_KEY) {
  ...
  console.warn('STRIPE_SECRET_KEY is not set — Stripe webhooks will be disabled.');
}
